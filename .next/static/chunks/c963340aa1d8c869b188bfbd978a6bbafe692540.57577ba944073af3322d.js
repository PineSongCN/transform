      ...
      (function(e) {
        ...
        (t.format = function(e) {
          ...
          for (
            var r = arguments,
              i = r.length,
              u = String(e).replace(o, function(e) {
                if ("%%" === e) return "%";
                if (n >= i) return e;
                switch (e) {
                  case "%s":
        ...
        function p(e, n, r) {
          ...
          var i = (function(e, t) {
            ...
            if (d(t)) return e.stylize("" + t, "number");
          ...
          if (
            (e.showHidden && (u = Object.getOwnPropertyNames(n)),
            w(n) &&
          ...
          var s,
            ...
            E = ["{", "}"];
          (y(n) && ((x = !0), (E = ["[", "]"])), S(n)) &&
            (O = " [Function" + (n.name ? ": " + n.name : "") + "]");
          return (
            v(n) && (O = " " + RegExp.prototype.toString.call(n)),
            j(n) && (O = " " + Date.prototype.toUTCString.call(n)),
            w(n) && (O = " " + l(n)),
        ...
        function a(e, t, n, r, o, i) {
          ...
          if (
            ((f = Object.getOwnPropertyDescriptor(t, o) || { value: t[o] }).get
              ...
              : f.set && (c = e.stylize("[Setter]", "special")),
            D(r, o) || (u = "[" + o + "]"),
            c ||
              (e.seen.indexOf(f.value) < 0
                ? (c = b(n)
                    ? p(e, f.value, null)
                    : p(e, f.value, n - 1)).indexOf("\n") > -1 &&
                  (c = i
                    ? c
                        .split("\n")
                        .map(function(e) {
        ...
        function v(e) {
          return O(e) && "[object RegExp]" === x(e);
        }
        function O(e) {
          return "object" === typeof e && null !== e;
        }
        function j(e) {
          return O(e) && "[object Date]" === x(e);
        }
        function w(e) {
          return O(e) && ("[object Error]" === x(e) || e instanceof Error);
        }
        function S(e) {
        ...
        (t.debuglog = function(n) {
          if (
            (m(i) && (i = e.env.NODE_DEBUG || ""), (n = n.toUpperCase()), !u[n])
          )
