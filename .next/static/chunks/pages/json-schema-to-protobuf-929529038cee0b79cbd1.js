  ...
  [51],
  {
    ...
    DQ9f: function(e, t) {
      var r = function(e, t) {
        ...
        n = function(e, t) {
          ...
          return (
            ...
            e.fields.forEach(function(e) {
              e.oneof
                ? (s[e.oneof] || (s[e.oneof] = []), s[e.oneof].push(r(e, [])))
                : t.push(r(e, []));
            }),
            Object.keys(s).forEach(function(e) {
              s[e].unshift("oneof " + e + " {"), s[e].push("}"), t.push(s[e]);
            }),
            t.push("}", ""),
            t
          );
        ...
        o = function(e, t) {
          t.push("enum " + e.name + " {");
          var r = Object.keys(e.values).map(function(t) {
            return t + " = " + e.values[t] + ";";
          });
          return t.push(r), t.push("}", ""), t;
        },
        s = function(e, t) {
          var r = Object.keys(e);
          return (
              ...
              "object" === o
                ? Array.isArray(n)
                  ? n.forEach(function(e) {
                      (e = i(e, [])).length && t.push(r + " {", e, "}");
                    })
                  : (n = i(n, [])).length && t.push(r + " {", n, "}")
                ...
                return s.a.wrap(function(e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (r = t.value), e.abrupt("return", p()(r));
                      case 2:
                      case "end":
                        return e.stop();
                    }
    ...
    kfWR: function(e, t, r) {
      var n = r("lelp"),
        ...
        i = function(e) {
          for (
            var t = { enums: [], messages: [], fields: [], extensions: null };
            e.length;
        ...
        u = function(e) {
          ...
          var t = 1,
            r = [],
            n = { name: e.shift(), enums: [], messages: [], fields: [] };
        ...
        h = function(e) {
          ...
          switch (t) {
            ...
            default:
              throw new Error(
                "Expected protobuf syntax version but found " + t
              );
          }
          if (";" !== e[0]) throw new Error("Expected ; but found " + e[0]);
          return e.shift(), t;
        ...
        c = function(e) {
          ...
          if (";" !== e[3]) throw new Error("Expected ; but found " + e[1]);
          var t = e.shift();
          e.shift();
          var r = Number(e.shift());
          return e.shift(), { name: t, value: r };
        },
        l = function(e) {
          e.shift();
          var t = { name: e.shift(), values: {} };
          if ("{" !== e[0]) throw new Error("Expected { but found " + e[0]);
          for (e.shift(); e.length; ) {
            if ("}" === e[0]) return e.shift(), ";" === e[0] && e.shift(), t;
            if ("option" === e[0]) for (; ";" !== e.shift(); );
            var r = c(e);
            t.values[r.name] = r.value;
          }
          ...
          for (
            ...
            switch (e[0]) {
              ...
              case "=":
                if ((e.shift(), null === t))
                  throw new Error(
                    "Expected key for option with value: " + e[0]
                  );
                if (
                  ((r = n(e.shift())),
                  "optimize_for" === t &&
                    !/^(SPEED|CODE_SIZE|LITE_RUNTIME)$/.test(r))
                )
                  throw new Error(
                    "Unexpected value for option optimize_for: " + r
                  );
                "{" === r && (r = d(e));
                break;
              default:
          ...
          for (
            ...
            switch (e[0]) {
              case ":":
                ...
                e.shift(), "{" === (s = t(e.shift())) && (s = d(e)), (r[o] = s);
                break;
              case "{":
                if (
                  (e.shift(),
        ...
        for (
          ...
          switch (t[0]) {
            ...
            case "option":
              var f = m(t);
              if (s.options[f.name])
                throw new Error("Duplicate option " + f.name);
              s.options[f.name] = f.value;
              break;
            case "import":
              s.imports.push(w(t));
              break;
            case "extend":
              ...
              break;
            case "service":
              s.services || (s.services = []), s.services.push(g(t));
              break;
            default:
    ...
    pIeg: function(e, t, r) {
      ...
      function s(e) {
        var t = { name: e.name, enums: [], messages: [], fields: [] },
          r = 1;
        for (var n in e.properties) {
          "object" === (f = e.properties[n]).type
            ? ((f.name = n), t.messages.push(s(f)))
            : ((f.name = n), t.fields.push(i(f, r)), (r += 1));
        }
        for (var o in e.required) {
          var a = e.required[o];
          for (var o in t.fields) {
            var f;
            a === (f = t.fields[o]).name && (f.required = !0);
          }
        }
        return t;
      }
      function i(e, t) {
        var r = o[e.type] || e.type,
          n = !1;
        return (
          "array" === e.type && ((n = !0), (r = e.items.type)),
          { name: e.name, type: r, tag: t, repeated: n }
        );
      }
      e.exports = function(e) {
        "string" === typeof e && (e = JSON.parse(e));
        var t = { syntax: 2, package: null, enums: [], messages: [] };
        return "object" === e.type && t.messages.push(s(e)), n.stringify(t);
      };
    },
    pof7: function(e, t, r) {
