  ...
  [28],
  {
    ...
    IKlv: function(e, t, r) {
      ...
      var M = function(e) {
        ...
        V = j || "";
      (r.p = "".concat(V, "/_next/")),
        w.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: O || {} });
      var K = (0, x.getURL)();
      (0, S.hasBasePath)(K) && (K = (0, S.delBasePath)(K));
              ...
              function(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 36:
                      return (
                        (t.router = Z = (0, N.createRouter)(I, q, K, {
                          initialProps: L,
                          pageLoader: Y,
                          App: $,
                          Component: ne,
          ...
          Y.loadPage("/_error").then(function(n) {
            var o = n.page,
              ...
              u = {
                ...
                AppTree: i,
                router: Z,
                ctx: { err: r, pathname: I, query: q, asPath: K, AppTree: i }
              };
