  ...
  [8],
  {
    ...
    "3BRs": function(e, t, n) {
      ...
      (function(t) {
        ...
        function b(e) {
          if (((o = o || n("sZro")), !c.call(b, this) && !(this instanceof o)))
            return new b(e);
    ...
    "8oxB": function(e, t) {
      ...
      function c() {
        f &&
          u &&
          ((f = !1), u.length ? (l = u.concat(l)) : (h = -1), l.length && d());
      }
      function d() {
        if (!f) {
          var e = s(c);
          ...
          (w.prototype.on = function(e, t) {
            ...
            if ("data" === e)
              ...
              r.endEmitted ||
                ...
                (r.emittedReadable = !1),
                r.reading ? r.length && x(this) : i.nextTick(j, this));
            }
            return n;
          }),
