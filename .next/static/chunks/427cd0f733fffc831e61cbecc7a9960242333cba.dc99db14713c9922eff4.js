  ...
  [15],
  {
      ...
      (e.isExist = function(t) {
        ...
        (e.buildOptions = function(t, e, n) {
          ...
          for (let i = 0; i < n.length; i++)
            void 0 !== t[n[i]] ? (r[n[i]] = t[n[i]]) : (r[n[i]] = e[n[i]]);
          return r;
        }),
        (e.isTagNameInArrayMode = function(t, e, n) {
          return (
            !1 !== e &&
            (e instanceof RegExp
              ? e.test(t)
    ...
    E1E9: function(t, e, n) {
      ...
      function l(t, e, n) {
        return (
          e &&
            (n.trimValues && (e = e.trim()),
            (e = c(
              (e = n.tagValueProcessor(e, t)),
              n.parseNodeValue,
              n.parseTrueNumberOnly
            ))),
          e
        );
      }
          ...
          return (
            "" === t.trim() || isNaN(t)
              ...
              : (-1 !== t.indexOf("0x")
                  ...
                  : -1 !== t.indexOf(".")
                  ? ((e = Number.parseFloat(t)), (t = t.replace(/\.?0+$/, "")))
      ...
      function f(t, e) {
        if (!e.ignoreAttributes && "string" === typeof t) {
          ...
          for (let t = 0; t < i; t++) {
            ...
            r.length &&
              (void 0 !== n[t][4]
                ? (e.trimValues && (n[t][4] = n[t][4].trim()),
                  (n[t][4] = e.attrValueProcessor(n[t][4], r)),
                  (s[e.attributeNamePrefix + r] = c(
                    n[t][4],
                    e.parseAttributeValue,
                    e.parseTrueNumberOnly
                  )))
                : e.allowBooleanAttributes &&
                  (s[e.attributeNamePrefix + r] = !0));
          }
      ...
      e.getTraversalObj = function(t, e) {
        ...
        for (let i = 0; i < t.length; i++) {
          if ("<" === t[i])
            if ("/" === t[i + 1]) {
              const n = g(t, ">", i, "Closing Tag is not closed.");
              let s = t.substring(i + 2, n).trim();
              if (e.ignoreNameSpace) {
                const t = s.indexOf(":");
                -1 !== t && (s = s.substr(t + 1));
              }
              u &&
                (u.val
                  ? (u.val = r.getValue(u.val) + "" + l(s, c, e))
                  : (u.val = l(s, c, e))),
                e.stopNodes.length &&
                  e.stopNodes.includes(u.tagname) &&
                  ((u.child = []),
                  void 0 == u.attrsMap && (u.attrsMap = {}),
                  (u.val = t.substr(u.startIndex + 1, i - u.startIndex - 1))),
                (u = u.parent),
                (c = ""),
                (i = n);
            } else if ("?" === t[i + 1])
              i = g(t, "?>", i, "Pi Tag is not closed.");
            else if ("!--" === t.substr(i + 1, 3))
              i = g(t, "--\x3e", i, "Comment is not closed.");
            else if ("!D" === t.substr(i + 1, 2)) {
              const e = g(t, ">", i, "DOCTYPE is not closed.");
              i =
                t.substring(i, e).indexOf("[") >= 0
                  ? t.indexOf("]>", i) + 1
                  : e;
            } else if ("![" === t.substr(i + 1, 2)) {
              const n = g(t, "]]>", i, "CDATA is not closed.") - 2,
                a = t.substring(i + 9, n);
              if (
                (c &&
                  ((u.val = r.getValue(u.val) + "" + l(u.tagname, c, e)),
                  (c = "")),
                e.cdataTagName)
              ) {
                const t = new s(e.cdataTagName, u, a);
                u.addChild(t),
                  (u.val = r.getValue(u.val) + e.cdataPositionChar),
                  a && (t.val = a);
              } else u.val = (u.val || "") + (a || "");
              i = n + 2;
            } else {
              ...
              if (
                (-1 !== d &&
                  ((g = a.substr(0, d).replace(/\s\s*$/, "")),
                  (a = a.substr(d + 1))),
                e.ignoreNameSpace)
              ) {
                const t = g.indexOf(":");
                -1 !== t &&
                  ((g = g.substr(t + 1)), (p = g !== n.data.substr(t + 1)));
              }
              if (
                (u &&
                  c &&
                ...
                "/" === g[g.length - 1]
                  ? ((g = g.substr(0, g.length - 1)), (a = g))
                  : (a = a.substr(0, a.length - 1));
                const t = new s(g, u, "");
                g !== a && (t.attrsMap = f(a, e)), u.addChild(t);
              } else {
                const t = new s(g, u);
                e.stopNodes.length &&
                  e.stopNodes.includes(t.tagname) &&
                  (t.startIndex = o),
                  g !== a && p && (t.attrsMap = f(a, e)),
                  u.addChild(t),
                  (u = t);
              }
              (c = ""), (i = o);
    ...
    cIfH: function(t, e, n) {
        ...
        return u
          ? !(n.length > 0) ||
              f(
                "InvalidXml",
                "Invalid '" +
                  JSON.stringify(n, null, 4).replace(/\r?\n/g, "") +
                  "' found.",
                1
              )
      ...
      function l(t, e) {
        ...
        return "" === r && { value: n, index: e, tagClosed: i };
      }
      const u = new RegExp(
        "(\\s*)([^\\s=]+)(\\s*=)?(\\s*(['\"])(([\\s\\S])*?)\\5)?",
        "g"
      ...
      function c(t, e) {
        ...
        for (let r = 0; r < n.length; r++) {
          ...
          if (void 0 === n[r][3] && !e.allowBooleanAttributes)
            return f(
              "InvalidAttr",
      ...
      function f(t, e, n) {
        return { err: { code: t, msg: e, line: n } };
      }
      function h(t) {
        return r.isName(t);
      }
    ...
    elGS: function(t, e, n) {
      ...
      (e.parse = function(t, e, n) {
        ...
        e = a(e, s.defaultOptions, s.props);
        const l = i.getTraversalObj(t, e);
        return r.convertToJson(l, e);
      }),
        (e.convertTonimn = n("vtNb").convert2nimn),
        (e.getTraversalObj = i.getTraversalObj),
        (e.convertToJson = r.convertToJson),
        (e.convertToJsonString = n("t6xR").convertToJsonString),
        (e.validate = o.validate),
        (e.j2xParser = n("p1mf")),
        (e.parseToNimn = function(t, n, r) {
          return e.convertTonimn(e.getTraversalObj(t, r), n, r);
        });
    },
    "j/LU": function(t, e, n) {
      "use strict";
      const r = n("4abu"),
        i = function(t, e, n) {
          const s = {};
          if (
            (!t.child || r.isEmptyObject(t.child)) &&
            (!t.attrsMap || r.isEmptyObject(t.attrsMap))
          )
            return r.isExist(t.val) ? t.val : "";
          if (
            r.isExist(t.val) &&
            ("string" !== typeof t.val ||
              ("" !== t.val && t.val !== e.cdataPositionChar))
          ) {
            const i = r.isTagNameInArrayMode(t.tagname, e.arrayMode, n);
            s[e.textNodeName] = i ? [t.val] : t.val;
          }
          r.merge(s, t.attrsMap, e.arrayMode);
          const a = Object.keys(t.child);
          for (let o = 0; o < a.length; o++) {
            const l = a[o];
            if (t.child[l] && t.child[l].length > 1) {
              s[l] = [];
              for (let n in t.child[l])
                t.child[l].hasOwnProperty(n) &&
                  s[l].push(i(t.child[l][n], e, l));
            } else {
              const a = i(t.child[l][0], e, l),
                o =
                  (!0 === e.arrayMode && "object" === typeof a) ||
                  r.isTagNameInArrayMode(l, e.arrayMode, n);
              s[l] = o ? [a] : a;
            }
          }
          return s;
      ...
      function a(t) {
        (this.options = r(t, i, s)),
          ...
          this.options.supressEmptyNode
            ? ((this.buildTextNode = f), (this.buildObjNode = c))
        ...
        (a.prototype.j2x = function(t, e) {
          ...
          for (let a = 0; a < s; a++) {
            ...
            if ("undefined" === typeof t[s]);
              ...
              r += this.indentate(e) + "<" + s + "/" + this.tagEndChar;
            else if (t[s] instanceof Date)
              r += this.buildTextNode(t[s], s, "", e);
              ...
              i
                ? (n +=
                    ...
                    i +
                    '="' +
                    this.options.attrValueProcessor("" + t[s]) +
                    '"')
                : this.isCDATA(s)
                ? t[this.options.textNodeName]
                  ...
                  : (r += this.replaceCDATAstr("", t[s]))
                : s === this.options.textNodeName
                ? t[this.options.cdataTagName] ||
                  (r += this.options.tagValueProcessor("" + t[s]))
                : (r += this.buildTextNode(t[s], s, "", e));
              ...
              if (this.isCDATA(s))
                ...
                for (let i = 0; i < n; i++) {
                  ...
                  if ("undefined" === typeof n);
                    ...
                    const t = this.j2x(n, e + 1);
                    r += this.buildObjNode(t.val, s, t.attrStr, e);
                  } else r += this.buildTextNode(n, s, "", e);
                }
              }
            else if (
              this.options.attrNodeName &&
              s === this.options.attrNodeName
            ) {
              ...
              for (let i = 0; i < r; i++)
                n +=
                  ...
                  e[i] +
                  '="' +
                  this.options.attrValueProcessor("" + t[s][e[i]]) +
                  '"';
            } else {
              const n = this.j2x(t[s], e + 1);
              r += this.buildObjNode(n.val, s, n.attrStr, e);
            }
          }
    ...
    t6xR: function(t, e, n) {
      ...
      const r = n("4abu"),
        ...
        a = function(t, e, n) {
          ...
          for (let r = 0; r < s.length; r++) {
            var o = s[r];
            if (t.child[o] && t.child[o].length > 1) {
              for (var l in ((i += '"' + o + '" : [ '), t.child[o]))
                i += a(t.child[o][l], e) + " , ";
              i = i.substr(0, i.length - 1) + " ] ";
            } else i += '"' + o + '" : ' + a(t.child[o][0], e) + " ,";
          }
          return (
            r.merge(i, t.attrsMap),
            r.isEmptyObject(i)
              ? r.isExist(t.val)
                ? t.val
                : ""
      ...
      e.convertToJsonString = function(t, e) {
        return (
          ((e = i(e, s.defaultOptions, s.props)).indentBy = e.indentBy || ""),
          a(t, e, 0)
        );
      };
    },
    ucdA: function(t, e, n) {
      ...
      const r = n("elGS"),
        i = t => {
          ...
          if (0 === (t = t.toString().trim()).length) return !1;
          if (!0 !== r.validate(t)) return !1;
          let e;
          try {
            e = r.parse(t);
          } catch (n) {
    ...
    vtNb: function(t, e, n) {
      ...
      const r = function(t) {
        ...
        a = function(t, e, n) {
          if ("string" === typeof e)
            return t && t[0] && void 0 !== t[0].val ? o(t[0].val, e) : o(t, e);
          {
            const s =
              void 0 === (r = t)
                ? i.missingChar
            ...
            if (!0 === s) {
              ...
              if (Array.isArray(e)) {
                ...
                for (let i in s) {
                  ...
                  let u;
                  (u =
                    !n.ignoreAttributes && t.attrsMap && t.attrsMap[o]
                      ? a(t.attrsMap[o], e[o], n)
                      : o === n.textNodeName
                      ? a(t.val, e[o], n)
                      : a(t.child[o], e[o], n)),
                    (r = l(r, u));
      ...
      const c = n("E1E9"),
        d = n("4abu").buildOptions;
      e.convert2nimn = function(t, e, n) {
        return (n = d(n, c.defaultOptions, c.props)), a(t, e, n);
      };
    }
  }
]);
